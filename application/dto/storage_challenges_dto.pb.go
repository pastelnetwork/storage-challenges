...
func (*GenerateStorageChallengeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_330a053522a8fb00, []int{5}
}
...
func (*GenerateStorageChallengeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_330a053522a8fb00, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*GenerateStorageChallengeRequest)(nil), "dto.GenerateStorageChallengeRequest")
	proto.RegisterType((*GenerateStorageChallengeReply)(nil), "dto.GenerateStorageChallengeReply")
}
...
var fileDescriptor_330a053522a8fb00 = []byte{
	...
	,
}
...
func (this *GenerateStorageChallengeRequest) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&dto.GenerateStorageChallengeRequest{")
	s = append(s, "ChallengingMasternodeId: "+fmt.Sprintf("%#v", this.ChallengingMasternodeId)+",\n")
...
func (this *GenerateStorageChallengeReply) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&dto.GenerateStorageChallengeReply{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *GenerateStorageChallengeRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CurrentBlockHash) > 0 {
		...
		i = encodeVarintStorageChallengesDto(dAtA, i, uint64(len(m.CurrentBlockHash)))
		i--
		dAtA[i] = 0x1a
	}
	if m.ChallengesPerMasternodePerBlock != 0 {
		i = encodeVarintStorageChallengesDto(dAtA, i, uint64(m.ChallengesPerMasternodePerBlock))
		i--
		dAtA[i] = 0x10
	}
	if len(m.ChallengingMasternodeId) > 0 {
...
func (m *GenerateStorageChallengeRequest) Size() (n int) {
	...
	if m.ChallengesPerMasternodePerBlock != 0 {
		n += 1 + sovStorageChallengesDto(uint64(m.ChallengesPerMasternodePerBlock))
	}
